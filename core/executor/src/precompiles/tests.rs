...
#[test]
fn test_ecrecover() {
    let input = hex_decode("").unwrap();
    let output =
        hex_decode("000000000000000000000000c08b5542d177ac6686946920409741463a15dddb").unwrap();

    test_precompile!(EcRecover, &input, output, 3000);
}
...
fn test_ripemd160() {
    let input = &[0xff];
    let output =
        hex_decode("0000000000000000000000002c0c45d3ecab80fe060e5f1d7057cd2f8de5e557").unwrap();
...
fn test_blake2f() {
    ...
    test_precompile!(Blake2F, input, output, 0);
