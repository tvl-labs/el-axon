...
pub mod avs_directory {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                ...
                (::std::borrow::ToOwned::to_owned("cancelSalt"), ::std::vec![
    ...
    impl<M: ::ethers::providers::Middleware> AVSDirectory<M> {
        ...
        /// Calls the contract's `OPERATOR_AVS_REGISTRATION_TYPEHASH`
        /// (0xd79aceab) function
        ...
        /// Calls the contract's `calculateOperatorAVSRegistrationDigestHash`
        /// (0xa1060c88) function
    ...
    /// `OPERATOR_AVS_REGISTRATION_TYPEHASH` function with signature
    /// `OPERATOR_AVS_REGISTRATION_TYPEHASH()` and selector `0xd79aceab`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `avsOperatorStatus`
    /// function with signature `avsOperatorStatus(address,address)` and
    /// selector `0x49075da3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `calculateOperatorAVSRegistrationDigestHash` function with signature
    /// `calculateOperatorAVSRegistrationDigestHash(address,address,bytes32,
    /// uint256)` and selector `0xa1060c88`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `cancelSalt` function
    /// with signature `cancelSalt(bytes32)` and selector `0xec76f442`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// with signature `initialize(address,address,uint256)` and selector
    /// `0x1794bb3c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `operatorSaltIsSpent`
    /// function with signature `operatorSaltIsSpent(address,bytes32)` and
    /// selector `0x374823b5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all return fields from the `avsOperatorStatus`
    /// function with signature `avsOperatorStatus(address,address)` and
    /// selector `0x49075da3`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `operatorSaltIsSpent`
    /// function with signature `operatorSaltIsSpent(address,bytes32)` and
    /// selector `0x374823b5`
    #[derive(
        Clone,
