...
pub mod erc20_mock {
    const _: () = {
        ::core::include_bytes!("/home/gao/dev/el-axon/avs-contract/ERC20Mock.json");
    };
    #[allow(deprecated)]
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                (::std::borrow::ToOwned::to_owned("allowance"), ::std::vec![
                ...
                (::std::borrow::ToOwned::to_owned("approve"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
                ...
                (::std::borrow::ToOwned::to_owned("balanceOf"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
                ...
                (::std::borrow::ToOwned::to_owned("mint"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
                ...
                (::std::borrow::ToOwned::to_owned("transfer"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
            ...
            events:      ::core::convert::From::from([
                (::std::borrow::ToOwned::to_owned("Approval"), ::std::vec![
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[Pa\x05'\x80a\0 `\09`\0\xF3\xFE`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[P`\x046\x10a\0}W`\x005`\xE0\x1C\x80c@\xC1\x0F\x19\x11a\0[W\x80c@\xC1\x0F\x19\x14a\0\xD2W\x80cp\xA0\x821\x14a\0\xE7W\x80c\xA9\x05\x9C\xBB\x14a\x01\x10W\x80c\xDDb\xED>\x14a\x01#W`\0\x80\xFD[\x80c\t^\xA7\xB3\x14a\0\x82W\x80c\x18\x16\r\xDD\x14a\0\xADW\x80c#\xB8r\xDD\x14a\0\xBFW[`\0\x80\xFD[a\0\x98a\0\x906`\x04a\x04\x10V[`\x01\x92\x91PPV[`@Q\x90\x15\x15\x81R` \x01[`@Q\x80\x91\x03\x90\xF3[`\x02T[`@Q\x90\x81R` \x01a\0\xA4V[a\0\x98a\0\xCD6`\x04a\x04:V[a\x01\\V[a\0\xE5a\0\xE06`\x04a\x04\x10V[a\x01sV[\0[a\0\xB1a\0\xF56`\x04a\x04vV[`\x01`\x01`\xA0\x1B\x03\x16`\0\x90\x81R` \x81\x90R`@\x90 T\x90V[a\0\x98a\x01\x1E6`\x04a\x04\x10V[a\x01\x81V[a\0\xB1a\x0116`\x04a\x04\x98V[`\x01`\x01`\xA0\x1B\x03\x91\x82\x16`\0\x90\x81R`\x01` \x90\x81R`@\x80\x83 \x93\x90\x94\x16\x82R\x91\x90\x91R T\x90V[`\0a\x01i\x84\x84\x84a\x01\x8BV[P`\x01\x93\x92PPPV[a\x01}\x82\x82a\x035V[PPV[`\x003a\x01i\x81\x85\x85[`\x01`\x01`\xA0\x1B\x03\x83\x16a\x01\xF4W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`%`$\x82\x01R\x7FERC20: transfer from the zero ad`D\x82\x01Rddress`\xD8\x1B`d\x82\x01R`\x84\x01[`@Q\x80\x91\x03\x90\xFD[`\x01`\x01`\xA0\x1B\x03\x82\x16a\x02VW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`#`$\x82\x01R\x7FERC20: transfer to the zero addr`D\x82\x01Rbess`\xE8\x1B`d\x82\x01R`\x84\x01a\x01\xEBV[`\x01`\x01`\xA0\x1B\x03\x83\x16`\0\x90\x81R` \x81\x90R`@\x90 T\x81\x11\x15a\x02\xCDW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`&`$\x82\x01R\x7FERC20: transfer amount exceeds b`D\x82\x01Realance`\xD0\x1B`d\x82\x01R`\x84\x01a\x01\xEBV[`\x01`\x01`\xA0\x1B\x03\x83\x81\x16`
\x01`\x01`\xA0\x1B\x03\x91\x82\x16`\0\x90\x81R`\x01` \x90\x81R`@\x80\x83 \x93\x90\x94\x16\x82R\x91\x90\x91R T\x90V[`\0a\x01i\x84\x84\x84a\x01\x8BV[P`\x01\x93\x92PPPV[a\x01}\x82\x82a\x035V[PPV[`\x003a\x01i\x81\x85\x85[`\x01`\x01`\xA0\x1B\x03\x83\x16a\x01\xF4W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`%`$\x82\x01R\x7FERC20: transfer from the zero ad`D\x82\x01Rddress`\xD8\x1B`d\x82\x01R`\x84\x01[`@Q\x80\x91\x03\x90\xFD[`\x01`\x01`\xA0\x1B\x03\x82\x16a\x02VW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`#`$\x82\x01R\x7FERC20: transfer to the zero addr`D\x82\x01Rbess`\xE8\x1B`d\x82\x01R`\x84\x01a\x01\xEBV[`\x01`\x01`\xA0\x1B\x03\x83\x16`\0\x90\x81R` \x81\x90R`@\x90 T\x81\x11\x15a\x02\xCDW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`&`$\x82\x01R\x7FERC20: transfer amount exceeds b`D\x82\x01Realance`\xD0\x1B`d\x82\x01R`\x84\x01a\x01\xEBV[`\x01`\x01`\xA0\x1B\x03\x83\x81\x16`\0\x81\x81R` \x81\x81R`@\x80\x83 \x80T\x87\x90\x03\x90U\x93\x86\x16\x80\x83R\x91\x84\x90 \x80T\x86\x01\x90U\x92Q\x84\x81R\x90\x92\x7F\xDD\xF2R\xAD\x1B\xE2\xC8\x9Bi\xC2\xB0h\xFC7\x8D\xAA\x95+\xA7\xF1c\xC4\xA1\x16(\xF5ZM\xF5#\xB3\xEF\x91\x01`@Q\x80\x91\x03\x90\xA3PPPV[`\x01`\x01`\xA0\x1B\x03\x82\x16a\x03\x8BW`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\x1F`$\x82\x01R\x7FERC20: mint to the zero address\0`D\x82\x01R`d\x01a\x01\xEBV[\x80`\x02`\0\x82\x82Ta\x03\x9D\x91\x90a\x04\xCBV[\x90\x91UPP`\x01`\x01`\xA0\x1B\x03\x82\x16`\0\x81\x81R` \x81\x81R`@\x80\x83 \x80T\x86\x01\x90UQ\x84\x81R\x7F\xDD\xF2R\xAD\x1B\xE2\xC8\x9Bi\xC2\xB0h\xFC7\x8D\xAA\x95+\xA7\xF1c\xC4\xA1\x16(\xF5ZM\xF5#\xB3\xEF\x91\x01`@Q\x80\x91\x03\x90\xA3PPV[\x805`\x01`\x01`\xA0\x1B\x03\x81\x16\x81\x14a\x04\x0BW`\0\x80\xFD[\x91\x90PV[`\0\x80`@\x83\x85\x03\x12\x15a\x04#W`\0\x80\xFD[a\x04,\x83a\x03\xF4V[\x94` \x93\x90\x93\x015\x93PPPV[`\0\x80`\0``\x84\x86\x03\x12\x15a\x04OW`\0\x80\xFD[a\x04X\x84a\x03\xF4V[\x92Pa\x04f` \x85\x01a\x03\xF4V[\x91P`@\x84\x015\x90P\x92P\x92P\x92V[`\0` \x82\x84\x03\x12\x15a\x04\x88W`\0\x80\xFD[a\x04\x91\x82a\x03\xF4V[\x93\x92PPPV[`\0\x80`@\x83\x85\x03\x12\x15a\x04\xABW`\0\x80\xFD[a\x04\xB4\x83a\x03\xF4V[\x91Pa\x04\xC2` \x84\x01a\x03\xF4V[\x90P\x92P\x92\x90PV[`\0\x82\x19\x82\x11\x15a\x04\xECWcNH{q`\xE0\x1B`\0R`\x11`\x04R`$`\0\xFD[P\x01\x90V\xFE\xA2dipfsX\"\x12 \xF6\xDA8\"\x01D.i\xA8`\xE6M\xD8\x8F\xE5\xF7\x06\xB4\xAB\x9B \xEF/\xEEw\x19\xB4!j\xE8\0OdsolcC\0\x08\x0C\x003";
    /// The deployed bytecode of the contract.
    pub static ERC20MOCK_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M> ::core::fmt::Debug for ERC20Mock<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ERC20Mock))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ERC20Mock<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ERC20MockEvents> {
            self.0
