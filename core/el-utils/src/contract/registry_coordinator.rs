...
pub mod registry_coordinator {
    ...
    impl<M: ::ethers::providers::Middleware> RegistryCoordinator<M> {
        ...
        /// Calls the contract's `OPERATOR_CHURN_APPROVAL_TYPEHASH` (0xca0de882)
        /// function
        ...
        /// Calls the contract's `PUBKEY_REGISTRATION_TYPEHASH` (0x9feab859)
        /// function
        ...
        /// Calls the contract's `calculateOperatorChurnApprovalDigestHash`
        /// (0x84ca5213) function
        ...
        /// Calls the contract's `getQuorumBitmapAtBlockNumberByIndex`
        /// (0x04ec6351) function
        ...
        /// Calls the contract's `getQuorumBitmapHistoryLength` (0x03fd3492)
        /// function
        ...
        /// Calls the contract's `getQuorumBitmapIndicesAtBlockNumber`
        /// (0xc391425e) function
        ...
        /// Calls the contract's `getQuorumBitmapUpdateByIndex` (0x1eb812da)
        /// function
        ...
        /// Calls the contract's `pubkeyRegistrationMessageHash` (0x3c2a7f4c)
        /// function
        ...
        /// Calls the contract's `registerOperatorWithChurn` (0x9b5d177b)
        /// function
        ...
        /// Calls the contract's `updateOperatorsForQuorum` (0x5140a548)
        /// function
    ...
    /// `OPERATOR_CHURN_APPROVAL_TYPEHASH` function with signature
    /// `OPERATOR_CHURN_APPROVAL_TYPEHASH()` and selector `0xca0de882`
    #[derive(
        Clone,
    ...
    /// Container type for all input parameters for the
    /// `PUBKEY_REGISTRATION_TYPEHASH` function with signature
    /// `PUBKEY_REGISTRATION_TYPEHASH()` and selector `0x9feab859`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `calculateOperatorChurnApprovalDigestHash` function with signature
    /// `calculateOperatorChurnApprovalDigestHash(address,bytes32,(uint8,
    /// address)[],bytes32,uint256)` and selector `0x84ca5213`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `churnApprover` function
    /// with signature `churnApprover()` and selector `0x054310e6`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `createQuorum` function
    /// with signature
    /// `createQuorum((uint32,uint16,uint16),uint96,(address,uint96)[])` and
    /// selector `0xd75b4c88`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `deregisterOperator`
    /// function with signature `deregisterOperator(bytes)` and selector
    /// `0xca4f2d97`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `ejectOperator` function
    /// with signature `ejectOperator(address,bytes)` and selector `0x6e3b17db`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `ejector` function with
    /// signature `ejector()` and selector `0x28f61b31`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getCurrentQuorumBitmap`
    /// function with signature `getCurrentQuorumBitmap(bytes32)` and selector
    /// `0x871ef049`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getOperator` function
    /// with signature `getOperator(address)` and selector `0x5865c60c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getOperatorFromId`
    /// function with signature `getOperatorFromId(bytes32)` and selector
    /// `0x296bb064`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getOperatorId` function
    /// with signature `getOperatorId(address)` and selector `0x13542a4e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getOperatorSetParams`
    /// function with signature `getOperatorSetParams(uint8)` and selector
    /// `0xe65797ad`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getOperatorStatus`
    /// function with signature `getOperatorStatus(address)` and selector
    /// `0xfd39105a`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getQuorumBitmapAtBlockNumberByIndex` function with signature
    /// `getQuorumBitmapAtBlockNumberByIndex(bytes32,uint32,uint256)` and
    /// selector `0x04ec6351`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getQuorumBitmapHistoryLength` function with signature
    /// `getQuorumBitmapHistoryLength(bytes32)` and selector `0x03fd3492`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `getQuorumBitmapIndicesAtBlockNumber` function with signature
    /// `getQuorumBitmapIndicesAtBlockNumber(uint32,bytes32[])` and selector
    /// `0xc391425e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getQuorumBitmapUpdateByIndex` function with signature
    /// `getQuorumBitmapUpdateByIndex(bytes32,uint256)` and selector
    /// `0x1eb812da`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `indexRegistry` function
    /// with signature `indexRegistry()` and selector `0x9e9923c2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// with signature
    /// `initialize(address,address,address,address,uint256,(uint32,uint16,
    /// uint16)[],uint96[],(address,uint96)[][])` and selector `0xdd8283f3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `isChurnApproverSaltUsed` function with signature
    /// `isChurnApproverSaltUsed(bytes32)` and selector `0x1478851f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `numRegistries` function
    /// with signature `numRegistries()` and selector `0xd72d8dd6`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `pubkeyRegistrationMessageHash` function with signature
    /// `pubkeyRegistrationMessageHash(address)` and selector `0x3c2a7f4c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `quorumCount` function
    /// with signature `quorumCount()` and selector `0x9aa1653d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `quorumUpdateBlockNumber` function with signature
    /// `quorumUpdateBlockNumber(uint8)` and selector `0x249a0c42`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `registerOperator`
    /// function with signature
    /// `registerOperator(bytes,string,((uint256,uint256),(uint256,uint256),
    /// (uint256[2],uint256[2])),(bytes,bytes32,uint256))` and selector
    /// `0xa50857bf`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `registerOperatorWithChurn` function with signature
    /// `registerOperatorWithChurn(bytes,string,((uint256,uint256),(uint256,
    /// uint256),(uint256[2],uint256[2])),(uint8,address)[],(bytes,bytes32,
    /// uint256),(bytes,bytes32,uint256))` and selector `0x9b5d177b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `registries` function
    /// with signature `registries(uint256)` and selector `0x6347c900`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `serviceManager`
    ...
    /// Container type for all input parameters for the `setChurnApprover`
    /// function with signature `setChurnApprover(address)` and selector
    /// `0x29d1e0c3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `setEjector` function
    /// with signature `setEjector(address)` and selector `0x2cdd1e86`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `setOperatorSetParams`
    /// function with signature
    /// `setOperatorSetParams(uint8,(uint32,uint16,uint16))` and selector
    /// `0x5b0b829f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `updateOperators`
    /// function with signature `updateOperators(address[])` and selector
    /// `0x00cf2ab5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `updateOperatorsForQuorum` function with signature
    /// `updateOperatorsForQuorum(address[][],bytes)` and selector `0x5140a548`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `updateSocket` function
    /// with signature `updateSocket(string)` and selector `0x0cf4b767`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all return fields from the `churnApprover` function
    /// with signature `churnApprover()` and selector `0x054310e6`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `ejector` function with
    /// signature `ejector()` and selector `0x28f61b31`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getCurrentQuorumBitmap`
    /// function with signature `getCurrentQuorumBitmap(bytes32)` and selector
    /// `0x871ef049`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getOperator` function
    /// with signature `getOperator(address)` and selector `0x5865c60c`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getOperatorFromId`
    /// function with signature `getOperatorFromId(bytes32)` and selector
    /// `0x296bb064`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getOperatorId` function
    /// with signature `getOperatorId(address)` and selector `0x13542a4e`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getOperatorSetParams`
    /// function with signature `getOperatorSetParams(uint8)` and selector
    /// `0xe65797ad`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getOperatorStatus`
    /// function with signature `getOperatorStatus(address)` and selector
    /// `0xfd39105a`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `indexRegistry` function
    /// with signature `indexRegistry()` and selector `0x9e9923c2`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `isChurnApproverSaltUsed`
    /// function with signature `isChurnApproverSaltUsed(bytes32)` and selector
    /// `0x1478851f`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `numRegistries` function
    /// with signature `numRegistries()` and selector `0xd72d8dd6`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `quorumCount` function
    /// with signature `quorumCount()` and selector `0x9aa1653d`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `quorumUpdateBlockNumber`
    /// function with signature `quorumUpdateBlockNumber(uint8)` and selector
    /// `0x249a0c42`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `registries` function with
    /// signature `registries(uint256)` and selector `0x6347c900`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// Container type for all return fields from the `serviceManager` function
    /// with signature `serviceManager()` and selector `0x3998fdd3`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// `PubkeyRegistrationParams((uint256,uint256),(uint256,uint256),
    /// (uint256[2],uint256[2]))`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
