...
pub mod service_manager_base {
    ...
    pub static SERVICEMANAGERBASE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> ServiceManagerBase<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ServiceManagerBaseEvents>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for ServiceManagerBaseEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(ServiceManagerBaseEvents::OwnershipTransferredFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<DeregisterOperatorFromAVSCall> for ServiceManagerBaseCalls {
        fn from(value: DeregisterOperatorFromAVSCall) -> Self {
            Self::DeregisterOperatorFromAVS(value)
        }
    }
    impl ::core::convert::From<GetOperatorRestakedStrategiesCall> for ServiceManagerBaseCalls {
        fn from(value: GetOperatorRestakedStrategiesCall) -> Self {
            Self::GetOperatorRestakedStrategies(value)
        }
    }
    impl ::core::convert::From<GetRestakeableStrategiesCall> for ServiceManagerBaseCalls {
