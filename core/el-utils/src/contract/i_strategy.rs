...
pub mod i_strategy {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                ...
                (::std::borrow::ToOwned::to_owned("shares"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
                ...
                (::std::borrow::ToOwned::to_owned("withdraw"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
    ...
    /// signature `deposit(address,uint256)` and selector `0x47e7ef24`
    #[derive(
        Clone,
    ...
    /// Container type for all input parameters for the `explanation` function
    /// with signature `explanation()` and selector `0xab5921e1`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `shares` function with
    /// signature `shares(address)` and selector `0xce7c2ac2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `sharesToUnderlying`
    /// function with signature `sharesToUnderlying(uint256)` and selector
    /// `0xf3e73875`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `sharesToUnderlyingView`
    /// function with signature `sharesToUnderlyingView(uint256)` and selector
    /// `0x7a8b2637`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `totalShares` function
    /// with signature `totalShares()` and selector `0x3a98ef39`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `underlyingToShares`
    /// function with signature `underlyingToShares(uint256)` and selector
    /// `0x8c871019`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `underlyingToSharesView`
    /// function with signature `underlyingToSharesView(uint256)` and selector
    /// `0xe3dae51c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `underlyingToken`
    ...
    /// Container type for all input parameters for the `userUnderlying`
    /// function with signature `userUnderlying(address)` and selector
    /// `0x8f6a6240`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `userUnderlyingView`
    /// function with signature `userUnderlyingView(address)` and selector
    /// `0x553ca5f8`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// signature `withdraw(address,address,uint256)` and selector `0xd9caed12`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all return fields from the `deposit` function with
    /// signature `deposit(address,uint256)` and selector `0x47e7ef24`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `explanation` function
    /// with signature `explanation()` and selector `0xab5921e1`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `shares` function with
    /// signature `shares(address)` and selector `0xce7c2ac2`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `sharesToUnderlying`
    /// function with signature `sharesToUnderlying(uint256)` and selector
    /// `0xf3e73875`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `sharesToUnderlyingView`
    /// function with signature `sharesToUnderlyingView(uint256)` and selector
    /// `0x7a8b2637`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `totalShares` function
    /// with signature `totalShares()` and selector `0x3a98ef39`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `underlyingToShares`
    /// function with signature `underlyingToShares(uint256)` and selector
    /// `0x8c871019`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `underlyingToSharesView`
    /// function with signature `underlyingToSharesView(uint256)` and selector
    /// `0xe3dae51c`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `underlyingToken` function
    /// with signature `underlyingToken()` and selector `0x2495a599`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// Container type for all return fields from the `userUnderlying` function
    /// with signature `userUnderlying(address)` and selector `0x8f6a6240`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// Container type for all return fields from the `userUnderlyingView`
    /// function with signature `userUnderlyingView(address)` and selector
    /// `0x553ca5f8`
    #[derive(
        Clone,
