...
pub mod i_slasher {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                (::std::borrow::ToOwned::to_owned("canSlash"), ::std::vec![
                ...
                (::std::borrow::ToOwned::to_owned("isFrozen"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
    ...
    impl<M: ::ethers::providers::Middleware> ISlasher<M> {
        ...
        /// Calls the contract's `contractCanSlashOperatorUntilBlock`
        /// (0x6f0c2f74) function
        ...
        /// Calls the contract's `getCorrectValueForInsertAfter` (0x723e59c7)
        /// function
        ...
        /// Calls the contract's `getMiddlewareTimesIndexServeUntilBlock`
        /// (0x7259a45c) function
        ...
        /// Calls the contract's `getMiddlewareTimesIndexStalestUpdateBlock`
        /// (0x1874e5ae) function
        ...
        /// Calls the contract's `operatorToMiddlewareTimes` (0x282670fc)
        /// function
        ...
        /// Calls the contract's `operatorWhitelistedContractsLinkedListEntry`
        /// (0x855fcc4a) function
        ...
        /// Calls the contract's `operatorWhitelistedContractsLinkedListSize`
        /// (0xe921d4fa) function
        ...
        /// Calls the contract's `recordLastStakeUpdateAndRevokeSlashingAbility`
        /// (0x0ffabbce) function
    ...
    /// Container type for all input parameters for the `canSlash` function with
    /// signature `canSlash(address,address)` and selector `0xd98128c0`
    #[derive(
        Clone,
    ...
    /// Container type for all input parameters for the `canWithdraw` function
    /// with signature `canWithdraw(address,uint32,uint256)` and selector
    /// `0x8105e043`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// `contractCanSlashOperatorUntilBlock` function with signature
    /// `contractCanSlashOperatorUntilBlock(address,address)` and selector
    /// `0x6f0c2f74`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getCorrectValueForInsertAfter` function with signature
    /// `getCorrectValueForInsertAfter(address,uint32)` and selector
    /// `0x723e59c7`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getMiddlewareTimesIndexServeUntilBlock` function with signature
    /// `getMiddlewareTimesIndexServeUntilBlock(address,uint32)` and selector
    /// `0x7259a45c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getMiddlewareTimesIndexStalestUpdateBlock` function with signature
    /// `getMiddlewareTimesIndexStalestUpdateBlock(address,uint32)` and selector
    /// `0x1874e5ae`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `isFrozen` function with
    /// signature `isFrozen(address)` and selector `0xe5839836`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `latestUpdateBlock`
    /// function with signature `latestUpdateBlock(address,address)` and
    /// selector `0xda16e29b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `middlewareTimesLength`
    /// function with signature `middlewareTimesLength(address)` and selector
    /// `0xa49db732`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `operatorToMiddlewareTimes` function with signature
    /// `operatorToMiddlewareTimes(address,uint256)` and selector `0x282670fc`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `operatorWhitelistedContractsLinkedListEntry` function with signature
    /// `operatorWhitelistedContractsLinkedListEntry(address,address)` and
    /// selector `0x855fcc4a`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `operatorWhitelistedContractsLinkedListSize` function with signature
    /// `operatorWhitelistedContractsLinkedListSize(address)` and selector
    /// `0xe921d4fa`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `optIntoSlashing`
    /// function with signature `optIntoSlashing(address)` and selector
    /// `0xf73b7519`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `recordFirstStakeUpdate`
    /// function with signature `recordFirstStakeUpdate(address,uint32)` and
    /// selector `0x175d3205`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `recordLastStakeUpdateAndRevokeSlashingAbility` function with signature
    /// `recordLastStakeUpdateAndRevokeSlashingAbility(address,uint32)` and
    /// selector `0x0ffabbce`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `recordStakeUpdate`
    /// function with signature
    /// `recordStakeUpdate(address,uint32,uint32,uint256)` and selector
    /// `0xc747075b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `resetFrozenStatus`
    /// function with signature `resetFrozenStatus(address[])` and selector
    /// `0x7cf72bba`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all return fields from the `canSlash` function with
    /// signature `canSlash(address,address)` and selector `0xd98128c0`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `canWithdraw` function
    /// with signature `canWithdraw(address,uint32,uint256)` and selector
    /// `0x8105e043`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `isFrozen` function with
    /// signature `isFrozen(address)` and selector `0xe5839836`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `latestUpdateBlock`
    /// function with signature `latestUpdateBlock(address,address)` and
    /// selector `0xda16e29b`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `middlewareTimesLength`
    /// function with signature `middlewareTimesLength(address)` and selector
    /// `0xa49db732`
    #[derive(
        Clone,
