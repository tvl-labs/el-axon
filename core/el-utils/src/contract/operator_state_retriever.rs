...
pub mod operator_state_retriever {
    ...
    pub static OPERATORSTATERETRIEVER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static OPERATORSTATERETRIEVER_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static OPERATORSTATERETRIEVER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl ::core::convert::From<GetCheckSignaturesIndicesCall> for OperatorStateRetrieverCalls {
    ...
    impl ::core::convert::From<GetQuorumBitmapsAtBlockNumberCall> for OperatorStateRetrieverCalls {
