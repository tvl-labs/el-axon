...
pub mod stake_registry {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                ...
                (::std::borrow::ToOwned::to_owned("delegation"), ::std::vec![
    ...
    impl<M: ::ethers::providers::Middleware> StakeRegistry<M> {
        ...
        /// Calls the contract's `MAX_WEIGHING_FUNCTION_LENGTH` (0x7c172347)
        /// function
        ...
        /// Calls the contract's `getStakeAtBlockNumberAndIndex` (0xf2be94ae)
        /// function
        ...
        /// Calls the contract's `getStakeUpdateIndexAtBlockNumber` (0xdd9846b9)
        /// function
        ...
        /// Calls the contract's `getTotalStakeAtBlockNumberFromIndex`
        /// (0xc8294c56) function
        ...
        /// Calls the contract's `getTotalStakeHistoryLength` (0x0491b41c)
        /// function
        ...
        /// Calls the contract's `getTotalStakeIndicesAtBlockNumber`
        /// (0x81c07502) function
        ...
        /// Calls the contract's `getTotalStakeUpdateAtIndex` (0xb6904b78)
        /// function
        ...
        /// Calls the contract's `setMinimumStakeForQuorum` (0xbc9a40c3)
        /// function
        ...
        /// Calls the contract's `weightOfOperatorForQuorum` (0x1f9b74e0)
        /// function
    ...
    /// `MAX_WEIGHING_FUNCTION_LENGTH` function with signature
    /// `MAX_WEIGHING_FUNCTION_LENGTH()` and selector `0x7c172347`
    #[derive(
        Clone,
    ...
    /// Container type for all input parameters for the `WEIGHTING_DIVISOR`
    ...
    /// Container type for all input parameters for the `addStrategies` function
    /// with signature `addStrategies(uint8,(address,uint96)[])` and selector
    /// `0xc601527d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// function with signature `deregisterOperator(bytes32,bytes)` and selector
    /// `0xbd29b8cd`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getCurrentStake`
    /// function with signature `getCurrentStake(bytes32,uint8)` and selector
    /// `0x5401ed27`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getCurrentTotalStake`
    /// function with signature `getCurrentTotalStake(uint8)` and selector
    /// `0xd5eccc05`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getLatestStakeUpdate`
    /// function with signature `getLatestStakeUpdate(bytes32,uint8)` and
    /// selector `0xf851e198`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getStakeAtBlockNumber`
    /// function with signature `getStakeAtBlockNumber(bytes32,uint8,uint32)`
    /// and selector `0xfa28c627`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `getStakeAtBlockNumberAndIndex` function with signature
    /// `getStakeAtBlockNumberAndIndex(uint8,uint32,bytes32,uint256)` and
    /// selector `0xf2be94ae`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getStakeHistory`
    /// function with signature `getStakeHistory(bytes32,uint8)` and selector
    /// `0x2cd95940`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getStakeHistoryLength`
    /// function with signature `getStakeHistoryLength(bytes32,uint8)` and
    /// selector `0x4bd26e09`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getStakeUpdateAtIndex`
    /// function with signature `getStakeUpdateAtIndex(uint8,bytes32,uint256)`
    /// and selector `0xac6bfb03`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `getStakeUpdateIndexAtBlockNumber` function with signature
    /// `getStakeUpdateIndexAtBlockNumber(bytes32,uint8,uint32)` and selector
    /// `0xdd9846b9`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getTotalStakeAtBlockNumberFromIndex` function with signature
    /// `getTotalStakeAtBlockNumberFromIndex(uint8,uint32,uint256)` and selector
    /// `0xc8294c56`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getTotalStakeHistoryLength` function with signature
    /// `getTotalStakeHistoryLength(uint8)` and selector `0x0491b41c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `getTotalStakeIndicesAtBlockNumber` function with signature
    /// `getTotalStakeIndicesAtBlockNumber(uint32,bytes)` and selector
    /// `0x81c07502`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getTotalStakeUpdateAtIndex` function with signature
    /// `getTotalStakeUpdateAtIndex(uint8,uint256)` and selector `0xb6904b78`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `initializeQuorum`
    /// function with signature
    /// `initializeQuorum(uint8,uint96,(address,uint96)[])` and selector
    /// `0xff694a77`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `minimumStakeForQuorum`
    /// function with signature `minimumStakeForQuorum(uint8)` and selector
    /// `0xc46778a5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `modifyStrategyParams`
    /// function with signature `modifyStrategyParams(uint8,uint256[],uint96[])`
    /// and selector `0x20b66298`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// function with signature `registerOperator(address,bytes32,bytes)` and
    /// selector `0x25504777`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `removeStrategies`
    /// function with signature `removeStrategies(uint8,uint256[])` and selector
    /// `0x5f1f2d77`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `setMinimumStakeForQuorum` function with signature
    /// `setMinimumStakeForQuorum(uint8,uint96)` and selector `0xbc9a40c3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `strategiesPerQuorum`
    /// function with signature `strategiesPerQuorum(uint8,uint256)` and
    /// selector `0x9f3ccf65`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `strategyParams`
    /// function with signature `strategyParams(uint8,uint256)` and selector
    /// `0x08732461`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `strategyParamsByIndex`
    /// function with signature `strategyParamsByIndex(uint8,uint256)` and
    /// selector `0xadc804da`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `strategyParamsLength`
    /// function with signature `strategyParamsLength(uint8)` and selector
    /// `0x3ca5a5f5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `updateOperatorStake`
    /// function with signature `updateOperatorStake(address,bytes32,bytes)` and
    /// selector `0x66acfefe`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `weightOfOperatorForQuorum` function with signature
    /// `weightOfOperatorForQuorum(uint8,address)` and selector `0x1f9b74e0`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all return fields from the `WEIGHTING_DIVISOR`
    /// function with signature `WEIGHTING_DIVISOR()` and selector `0x5e5a6775`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getCurrentStake` function
    /// with signature `getCurrentStake(bytes32,uint8)` and selector
    /// `0x5401ed27`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getCurrentTotalStake`
    /// function with signature `getCurrentTotalStake(uint8)` and selector
    /// `0xd5eccc05`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getLatestStakeUpdate`
    /// function with signature `getLatestStakeUpdate(bytes32,uint8)` and
    /// selector `0xf851e198`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getStakeAtBlockNumber`
    /// function with signature `getStakeAtBlockNumber(bytes32,uint8,uint32)`
    /// and selector `0xfa28c627`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getStakeHistory` function
    /// with signature `getStakeHistory(bytes32,uint8)` and selector
    /// `0x2cd95940`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getStakeHistoryLength`
    /// function with signature `getStakeHistoryLength(bytes32,uint8)` and
    /// selector `0x4bd26e09`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getStakeUpdateAtIndex`
    /// function with signature `getStakeUpdateAtIndex(uint8,bytes32,uint256)`
    /// and selector `0xac6bfb03`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `minimumStakeForQuorum`
    /// function with signature `minimumStakeForQuorum(uint8)` and selector
    /// `0xc46778a5`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `registerOperator`
    /// function with signature `registerOperator(address,bytes32,bytes)` and
    /// selector `0x25504777`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `strategiesPerQuorum`
    /// function with signature `strategiesPerQuorum(uint8,uint256)` and
    /// selector `0x9f3ccf65`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `strategyParams` function
    /// with signature `strategyParams(uint8,uint256)` and selector `0x08732461`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// Container type for all return fields from the `strategyParamsByIndex`
    /// function with signature `strategyParamsByIndex(uint8,uint256)` and
    /// selector `0xadc804da`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `strategyParamsLength`
    /// function with signature `strategyParamsLength(uint8)` and selector
    /// `0x3ca5a5f5`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `updateOperatorStake`
    /// function with signature `updateOperatorStake(address,bytes32,bytes)` and
    /// selector `0x66acfefe`
    #[derive(
        Clone,
