...
pub mod strategy_manager {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                ...
                (::std::borrow::ToOwned::to_owned("addShares"), ::std::vec![
                ...
                (::std::borrow::ToOwned::to_owned("nonces"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name:             ::std::borrow::ToOwned::to_owned("withdrawalRootPending",),
                        inputs:           ::std::vec![::ethers::core::abi::ethabi::Param {
                            name:          ::std::string::String::new(),
                            kind:          ::ethers::core::abi::ethabi::ParamType::FixedBytes(
                                32usize,
            ...
            events:      ::core::convert::From::from([
                (::std::borrow::ToOwned::to_owned("Deposit"), ::std::vec![
    ...
    impl<M: ::ethers::providers::Middleware> StrategyManager<M> {
        ...
        /// Calls the contract's `addStrategiesToDepositWhitelist` (0xdf5b3547)
        /// function
        ...
        /// Calls the contract's `depositIntoStrategyWithSignature` (0x32e89ace)
        /// function
        ...
        /// Calls the contract's `removeStrategiesFromDepositWhitelist`
        /// (0xb5d8b5b8) function
        ...
        /// Calls the contract's `setThirdPartyTransfersForbidden` (0x4e5a4263)
        /// function
        ...
        /// Calls the contract's `stakerStrategyListLength` (0x8b8aac3c)
        /// function
        ...
        /// Calls the contract's `strategyIsWhitelistedForDeposit` (0x663c1de4)
        /// function
        ...
        /// Calls the contract's `thirdPartyTransfersForbidden` (0x9b4da03d)
        /// function
    ...
    /// Container type for all input parameters for the `DEPOSIT_TYPEHASH`
    ...
    /// Container type for all input parameters for the `addShares` function
    /// with signature `addShares(address,address,address,uint256)` and selector
    /// `0xc4623ea1`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// `addStrategiesToDepositWhitelist` function with signature
    /// `addStrategiesToDepositWhitelist(address[],bool[])` and selector
    /// `0xdf5b3547`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// `calculateWithdrawalRoot((address[],uint256[],address,(address,uint96),
    /// uint32,address))` and selector `0xb43b514b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `depositIntoStrategy`
    /// function with signature `depositIntoStrategy(address,address,uint256)`
    /// and selector `0xe7a050aa`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the
    /// `depositIntoStrategyWithSignature` function with signature
    /// `depositIntoStrategyWithSignature(address,address,uint256,address,
    /// uint256,bytes)` and selector `0x32e89ace`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getDeposits` function
    /// with signature `getDeposits(address)` and selector `0x94f649dd`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// with signature `initialize(address,address,address,uint256)` and
    /// selector `0xcf756fdf`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `migrateQueuedWithdrawal` function with signature
    /// `migrateQueuedWithdrawal((address[],uint256[],address,(address,uint96),
    /// uint32,address))` and selector `0xcd293f6f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `removeShares` function
    /// with signature `removeShares(address,address,uint256)` and selector
    /// `0x8c80d4e5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `removeStrategiesFromDepositWhitelist` function with signature
    /// `removeStrategiesFromDepositWhitelist(address[])` and selector
    /// `0xb5d8b5b8`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `setStrategyWhitelister`
    /// function with signature `setStrategyWhitelister(address)` and selector
    /// `0xc6656702`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `setThirdPartyTransfersForbidden` function with signature
    /// `setThirdPartyTransfersForbidden(address,bool)` and selector
    /// `0x4e5a4263`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `stakerStrategyList`
    /// function with signature `stakerStrategyList(address,uint256)` and
    /// selector `0xcbc2bd62`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `stakerStrategyListLength` function with signature
    /// `stakerStrategyListLength(address)` and selector `0x8b8aac3c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `stakerStrategyShares`
    /// function with signature `stakerStrategyShares(address,address)` and
    /// selector `0x7a7e0d92`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `strategyIsWhitelistedForDeposit` function with signature
    /// `strategyIsWhitelistedForDeposit(address)` and selector `0x663c1de4`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `strategyWhitelister`
    /// function with signature `strategyWhitelister()` and selector
    /// `0x967fc0d2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `thirdPartyTransfersForbidden` function with signature
    /// `thirdPartyTransfersForbidden(address)` and selector `0x9b4da03d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `withdrawSharesAsTokens`
    /// function with signature
    /// `withdrawSharesAsTokens(address,address,uint256,address)` and selector
    /// `0xc608c7f3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `withdrawalRootPending`
    /// function with signature `withdrawalRootPending(bytes32)` and selector
    /// `0xc3c6b3a9`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    impl ::ethers::core::abi::AbiDecode for StrategyManagerCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <WithdrawalRootPendingCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    /// Container type for all return fields from the `DEPOSIT_TYPEHASH`
    /// function with signature `DEPOSIT_TYPEHASH()` and selector `0x48825e94`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `depositIntoStrategy`
    /// function with signature `depositIntoStrategy(address,address,uint256)`
    /// and selector `0xe7a050aa`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getDeposits` function
    /// with signature `getDeposits(address)` and selector `0x94f649dd`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `migrateQueuedWithdrawal`
    /// function with signature
    /// `migrateQueuedWithdrawal((address[],uint256[],address,(address,uint96),
    /// uint32,address))` and selector `0xcd293f6f`
    #[derive(
    ...
    /// Container type for all return fields from the `stakerStrategyList`
    /// function with signature `stakerStrategyList(address,uint256)` and
    /// selector `0xcbc2bd62`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `stakerStrategyListLength`
    /// function with signature `stakerStrategyListLength(address)` and selector
    /// `0x8b8aac3c`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `stakerStrategyShares`
    /// function with signature `stakerStrategyShares(address,address)` and
    /// selector `0x7a7e0d92`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `strategyWhitelister`
    /// function with signature `strategyWhitelister()` and selector
    /// `0x967fc0d2`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `withdrawalRootPending`
    /// function with signature `withdrawalRootPending(bytes32)` and selector
    /// `0xc3c6b3a9`
    #[derive(
        Clone,
