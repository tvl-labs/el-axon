...
pub mod bls_apk_registry {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions:   ::core::convert::From::from([
                (::std::borrow::ToOwned::to_owned("apkHistory"), ::std::vec![
                ...
                (::std::borrow::ToOwned::to_owned("currentApk"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
                ...
                (::std::borrow::ToOwned::to_owned("getApk"), ::std::vec![
                    ::ethers::core::abi::ethabi::Function {
    ...
    impl<M: ::ethers::providers::Middleware> BLSApkRegistry<M> {
        ...
        /// Calls the contract's `getApkHashAtBlockNumberAndIndex` (0x68bccaac)
        /// function
        ...
        /// Calls the contract's `getApkIndicesAtBlockNumber` (0xd5254a8c)
        /// function
        ...
        /// Calls the contract's `getOperatorFromPubkeyHash` (0x47b314e8)
        /// function
    ...
    /// Container type for all input parameters for the `apkHistory` function
    /// with signature `apkHistory(uint8,uint256)` and selector `0x7916cea6`
    #[derive(
        Clone,
    ...
    /// Container type for all input parameters for the `currentApk` function
    /// with signature `currentApk(uint8)` and selector `0xa3db80e2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// function with signature `deregisterOperator(address,bytes)` and selector
    /// `0xf4e24fe5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getApk` function with
    /// signature `getApk(uint8)` and selector `0x5f61a884`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// `getApkHashAtBlockNumberAndIndex` function with signature
    /// `getApkHashAtBlockNumberAndIndex(uint8,uint32,uint256)` and selector
    /// `0x68bccaac`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `getApkHistoryLength`
    /// function with signature `getApkHistoryLength(uint8)` and selector
    /// `0x377ed99d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getApkIndicesAtBlockNumber` function with signature
    /// `getApkIndicesAtBlockNumber(bytes,uint256)` and selector `0xd5254a8c`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getApkUpdateAtIndex`
    /// function with signature `getApkUpdateAtIndex(uint8,uint256)` and
    /// selector `0x605747d5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the
    /// `getOperatorFromPubkeyHash` function with signature
    /// `getOperatorFromPubkeyHash(bytes32)` and selector `0x47b314e8`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// Container type for all input parameters for the `getRegisteredPubkey`
    /// function with signature `getRegisteredPubkey(address)` and selector
    /// `0x7ff81a87`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// function with signature `initializeQuorum(uint8)` and selector
    /// `0x26d941f2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `operatorToPubkey`
    /// function with signature `operatorToPubkey(address)` and selector
    /// `0x00a1f4cb`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `operatorToPubkeyHash`
    /// function with signature `operatorToPubkeyHash(address)` and selector
    /// `0xde29fac0`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `pubkeyHashToOperator`
    /// function with signature `pubkeyHashToOperator(bytes32)` and selector
    /// `0xe8bb9ae6`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all input parameters for the `registerBLSPublicKey`
    /// function with signature
    /// `registerBLSPublicKey(address,((uint256,uint256),(uint256,uint256),
    /// (uint256[2],uint256[2])),(uint256,uint256))` and selector `0xbf79ce58`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// function with signature `registerOperator(address,bytes)` and selector
    /// `0x3fb27952`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// Container type for all return fields from the `apkHistory` function with
    /// signature `apkHistory(uint8,uint256)` and selector `0x7916cea6`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `currentApk` function with
    /// signature `currentApk(uint8)` and selector `0xa3db80e2`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    /// Container type for all return fields from the `getApk` function with
    /// signature `getApk(uint8)` and selector `0x5f61a884`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// Container type for all return fields from the `getApkHistoryLength`
    /// function with signature `getApkHistoryLength(uint8)` and selector
    /// `0x377ed99d`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getApkUpdateAtIndex`
    /// function with signature `getApkUpdateAtIndex(uint8,uint256)` and
    /// selector `0x605747d5`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `getRegisteredPubkey`
    /// function with signature `getRegisteredPubkey(address)` and selector
    /// `0x7ff81a87`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `operatorToPubkey`
    /// function with signature `operatorToPubkey(address)` and selector
    /// `0x00a1f4cb`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `operatorToPubkeyHash`
    /// function with signature `operatorToPubkeyHash(address)` and selector
    /// `0xde29fac0`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `pubkeyHashToOperator`
    /// function with signature `pubkeyHashToOperator(bytes32)` and selector
    /// `0xe8bb9ae6`
    #[derive(
        Clone,
    ...
    /// Container type for all return fields from the `registerBLSPublicKey`
    /// function with signature
    /// `registerBLSPublicKey(address,((uint256,uint256),(uint256,uint256),
    /// (uint256[2],uint256[2])),(uint256,uint256))` and selector `0xbf79ce58`
    #[derive(
